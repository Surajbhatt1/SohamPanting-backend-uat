...
try {
  ...
  console.error(
    "Email log initialization failed:",
    error.message
  );
}
...
router.post("/contact", async (req, res) => {
  ...
  try {
    ...
    const subject =
      `New Painting Enquiry - ${cleanData.name}`;
  ...
  <div style="padding:30px;">
    ...
    >
      ...
      <tr>
        ...
        <td>
          ${cleanData.requirements || "Not provided"}
        </td>
      </tr>
